...
RegisterNetEvent('hospital:client:CheckStatus', function()
    ...
    if player ~= -1 and distance < 5.0 then
            ...
            if result then
                for k, v in pairs(result) do
                    ...
                    elseif result["BLEED"] > 0 then
                        ...
                        QBCore.Functions.Notify("Oyuncu sağlıklı durumda.", "success")
                    end
                end
        ...
        QBCore.Functions.Notify("Yakınlarda oyuncu bulunamadı!", "error")
    end
end)
    ...
    if hasItem then
        ...
        if player ~= -1 and distance < 5.0 then
            ...
            QBCore.Functions.Progressbar("hospital_revive", Lang:t('progress.revive'), 5000, false, true, {
                ...
                QBCore.Functions.Notify("Kişi canlandırıldı.", "success")
        ...
        QBCore.Functions.Notify("İlk yardım setine ihtiyacınız var!", "error")
    end
end)
    ...
    if hasItem then
        ...
        if player ~= -1 and distance < 5.0 then
            ...
            QBCore.Functions.Progressbar("hospital_healwounds", Lang:t('progress.healing'), 5000, false, true, {
                ...
                StopAnimTask(PlayerPedId(), healAnimDict, "exit", 1.0)
                QBCore.Functions.Notify("Kişiye yardım ettin.", "success")
        ...
        QBCore.Functions.Notify("Bandaja ihtiyacınız var!", "error")
    end
end)
...
if Config.UseTarget then
    CreateThread(function()
        ...
        for k, v in pairs(Config.Locations["main"]) do
            exports['qb-target']:AddBoxZone("main" .. k, vector3(v.x, v.y, v.z), 3.0, 3.0, {
                name = "main" .. k,
                debugPoly = false,
                heading = -20,
                minZ = v.z - 2,
